...
const EditExperience = () => {
  const { data, updateExperience, addExperience, removeExperience, updateExperienceOrder } = usePortfolio();
  ...
  const handleDragEnd = async (result: any) => {
    ...
    await updateExperienceOrder(items.map(item => item.id));

    toast({
      title: "Experience Reordered",
      description: "Experience entries have been reordered successfully.",
    });
  };
